        ...
        <>
            <div className='home-container'>
                ...
                <motion.div
                    ...
                    <Link target="_blank" to='https://github.com/hajjimajed' className='social-media-link'> <Github className='social-media-icon' /></Link>
                    <Link target="_blank" to='https://www.linkedin.com/in/majed-hajji-27a5a41b2/' className='social-media-link'> <Linkedin className='social-media-icon' /></Link>
                    <Link target="_blank" to='https://www.instagram.com/majed_hajjii/' className='social-media-link'> <Instagram className='social-media-icon' /></Link>
                </motion.div>
            </div>
